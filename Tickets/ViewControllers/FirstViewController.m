...
- (void)createContentDataArray {
    ...
    NSArray *titles = [NSArray arrayWithObjects:[@"about_app_header" localize], [@"tickets_header" localize],
                       [@"map_price_header" localize], [@"favorites_header" localize], nil];
    NSArray *contents = [NSArray arrayWithObjects:[@"about_app_describe" localize],
                         [@"tickets_describe" localize], [@"map_price_describe" localize],
